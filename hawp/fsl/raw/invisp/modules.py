# Copied from DarkFeat: /home/rjyu/code/DarkFeat/datasets/InvISP/model/modules.py
# Original InvISP implementation from Invertible-ISP, vendored for RawPLNet Raw synthesis.
import math
import torch

# Copied from DarkFeat: /home/rjyu/code/DarkFeat/datasets/noise_simulator.py
# Adapted only for RawPLNet package-local imports. Core InvISP/ELD synthesis logic is retained.
...
from .invisp.model import InvISPNet
from .noise import camera_params, addGStarNoise, addPStarNoise, addQuantNoise, addRowNoise, sampleK
...
class NoiseSimulator:
    def __init__(self, device, ckpt_path='./datasets/InvISP/pretrained/canon.pth', ratio_min=1.0, ratio_max=50.0):
        ...
        self.net.load_state_dict(torch.load(ckpt_path, map_location=self.device), strict=False)
        print("Loaded ISPNet checkpoint: {}".format(ckpt_path))
